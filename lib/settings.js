 ...
 */
Settings.prototype.defaultSmtpUser = () => defaultSmtpUser;
...
s.read('default').then(settings => {
  ...
  defaultSmtpUser = {
    ...
    smtp: {
      ...
      secure: settings.default_smtp_secure,
      auth: {
        user: settings.default_smtp_auth_user,
        pass: settings.default_smtp_auth_pass
      }
    }
  };
